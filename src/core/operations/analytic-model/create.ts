...
export async function createAnalyticModel(
    ...
    debug(`Creating analytic model "${objectName}"...`);
    ...
    return checkResponse(response, reqErr, `Create analytic model "${objectName}"`);
}
