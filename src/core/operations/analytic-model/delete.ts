...
export async function deleteAnalyticModel(
    ...
    debug(`Deleting analytic model "${objectName}"...`);
    ...
    return checkResponse(response, reqErr, `Delete analytic model "${objectName}"`);
}
